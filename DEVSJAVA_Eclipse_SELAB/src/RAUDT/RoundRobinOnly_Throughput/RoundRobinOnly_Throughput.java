...
public class RoundRobinOnly_Throughput extends ViewableDigraph
{
	public RoundRobinOnly_Throughput()
	{
		super("RoundRobinOnly");
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("User #3")).setPreferredLocation(new Point(521, 66));
        ...
        ((ViewableComponent)withName("ThruputCalc")).setPreferredLocation(new Point(1019, 300));
        ((ViewableComponent)withName("User #4")).setPreferredLocation(new Point(690, 65));
    }
}
