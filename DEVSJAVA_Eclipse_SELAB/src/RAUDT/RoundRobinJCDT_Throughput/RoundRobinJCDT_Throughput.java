...
public class RoundRobinJCDT_Throughput extends ViewableDigraph
{
	public RoundRobinJCDT_Throughput()
	{
		super("RoundRobinJCDT");
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("ThruputCalc")).setPreferredLocation(new Point(1003, 302));
    }
}
